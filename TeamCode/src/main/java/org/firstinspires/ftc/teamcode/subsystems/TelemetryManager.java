...
public class TelemetryManager extends SubsystemBase {
    ...
    private final Hardware[] subsystems;
    private MecanumDrive drive;
    private final ElapsedTime elapsedTime = new ElapsedTime();
    private int loops = 0;

    public TelemetryManager(Telemetry telemetry, Hardware... subsystems) {
        this.telemetry = telemetry;
        this.subsystems = subsystems;
        init();
    }
    public TelemetryManager(Telemetry telemetry, MecanumDrive drive, Hardware... subsystems){
        this.telemetry = telemetry;
        this.drive = drive;
        this.subsystems = subsystems;
        teleOpMessage();
    ...
    public void init() {
        ...
        for (Hardware subsystem: subsystems) {
            subsystem.init();
        }
        telemetry.update();
    }
